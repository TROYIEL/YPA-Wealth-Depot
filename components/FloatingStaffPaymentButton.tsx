  ...
  const validate = () => {
    ...
    if (
      ...
      if (
        ...
        return (
          "Complete the Mobile Money details."
        );
              ...
              {success ? (
                ...
                >
                  ...
                  {error && (
                    ...
                    <div className="mb-3 flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 text-xs font-medium text-red-700">
                  ...
                  <label className="mb-3 flex cursor-pointer items-start gap-2 rounded-lg bg-gray-50 px-3 py-2">
                    ...
                    <span className="text-[11px] leading-4 text-gray-600">
                      ...
                      I confirm that the staff and payment information entered above is correct.
