    ...
    <section className="relative h-105 overflow-hidden">
      ...
      <Container className="relative z-10 flex h-full items-center justify-center">
        <div className="max-w-4xl text-center text-white">
          ...
          <div className="mt-8 flex justify-center gap-2 text- text-white/80">
            <span>Home</span>
            <span>/</span>
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-16">
        ...
        <div className="mt-10 space-y-7 text-lg leading-9 text-slate-600">
          ...
          <p>
            YPA Wealth Depot is a member-owned Savings and Credit Cooperative
            dedicated to promoting financial inclusion through reliable savings,
            affordable loans, and innovative financial services that improve
            the economic wellbeing of our members.
          </p>

          <p>
            We mobilize savings, provide accessible credit, and encourage
            financial discipline while maintaining the highest standards of
            integrity, transparency, and accountability.
          </p>

          <p>
            Through sustainable financial solutions, strategic partnerships,
            and member education, we empower individuals, families, and
            businesses to build lasting wealth and achieve financial security.
          </p>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-3xl bg-blue-50 p-10 border border-blue-100">
